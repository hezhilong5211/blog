      ...
      <el-col :md="8" :sm="8" :xs="12" class="right">
        <el-dropdown trigger="click" class="notice">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item
              ><el-badge :value="12">评论</el-badge></el-dropdown-item
            >
            <el-dropdown-item
              ><el-badge :value="9">阅读</el-badge></el-dropdown-item
            >
          </el-dropdown-menu>
        </el-dropdown>
        <el-dropdown trigger="click" class="user-infor">
          ...
          <el-dropdown-menu slot="dropdown">
            <el-dropdown-item @click.native="uploadDisplay"
              >更改头像</el-dropdown-item
            >
            <el-dropdown-item @click.native="logoutAdmin"
              >退出</el-dropdown-item
            >
          </el-dropdown-menu>
        </el-dropdown>
