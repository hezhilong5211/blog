  ...
  <div class="list">
    ...
    <el-table :data="delFlag ? articlesDel : articles" border style="width:100%">
      ...
      <el-table-column label="操作" min-width="220">
        <template slot-scope="scope">
          <el-button size="small" type="primary" v-show="!delFlag"  @click="editorHandle(scope.row)">编辑</el-button>
          <el-button size="small" type="warning" v-show="!delFlag"  v-if="scope.row.state === 1" @click="operateHandle(scope.row, 2)">存稿</el-button>
          <el-button size="small" type="success" v-show="!delFlag"  v-if="scope.row.state === 2" @click="operateHandle(scope.row, 1)">发布</el-button>
          <el-button size="small" type="danger" v-show="!delFlag"  @click="operateHandle(scope.row, 0, scope.$index)">删除</el-button>
          <el-button size="small" type="success" v-show="delFlag"  @click="operateHandle(scope.row, 2, scope.$index)">还原</el-button>
          <el-button size="small" type="danger" v-show="delFlag"  @click="operateHandle(scope.row, 3, scope.$index)">彻底删除</el-button>
        </template>
      </el-table-column>
    </el-table>
  </div>
